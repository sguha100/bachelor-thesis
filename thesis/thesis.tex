...
We define the \emph{maximum constant} $c_x$ for a clock $x$ to be the
...
\subsubsection{Proof of correctness}
Since a zone-valuation graph is minimal modulo strong time-abstracted
bisimilarity, verifying a relation on two timed automata is equivalent
to verifying it on the symbolic states containing
the initial states of the timed automata in their respective
zone-valuation graphs.
